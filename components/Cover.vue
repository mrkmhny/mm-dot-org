...
<style lang='scss'>
  ...
  .cover__divider {
    ...
    &__large {
      ...
      width: 100%;
      margin-bottom: 1em;
      animation: slideFromLeft 1s both 1s;
    }
  ...
  #cover__title {
    ...
    animation: rise 1s both 2s, shadowChange 50s infinite linear;
  ...
  @keyframes slideFromLeft { 0% {transform: translateX(-9999px)} }
  @keyframes rise { 
